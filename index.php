...
<head>
    ...
    <link rel="icon" href="#">
    <title>Food Picky - Srilanka</title>
    <!-- Bootstrap core CSS -->
        ...
        <section class="hero bg-image" data-image-src="images/img/main2.jpg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    ...
                    <h5 class="font-white space-xs"><i>Find Restaurants, Specials, and Coupons For Free ... </i></h5>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2><b><u>Popular Dishes of the Month</u></b></h2>
                    <p class="lead"><i>The Easiest Way To Your Favourite Food</i></p>
                </div>
                <div class="row">
                    ...
                    <div class="row how-it-works-solution">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                            <div class="step step-3">
                                ...
                                <p><i>Get your food delivered! And enjoy your meal! Pay online On pickup or delivery</i></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="title-block pull-left">
                            <h4><b><u>Featured Restaurants</u></b></h4> </div>
                    </div>
                    <div class="col-sm-8">
